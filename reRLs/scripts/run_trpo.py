...
from reRLs.agents.trpo_agent import TRPOAgent
...
class TRPO_Trainer():
    ...
    def __init__(self, config: Dict):
        ...
        # natural policy gradient args
        natural_policy_gradient_args = {
        ...
        agent_train_args = {
            ...
            'num_critic_update_steps_per_train': config['num_critic_update_steps_per_train']
        }
        ...
        self.config = config
        self.config['agent_class'] = TRPOAgent
...
def get_parser():
    ...
    parser.add_argument('--num_critic_update_steps_per_train', type=int, default=5) #critic update steps per agent train step
